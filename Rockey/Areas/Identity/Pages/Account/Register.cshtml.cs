...
namespace Rockey.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if(!await _roleManager.RoleExistsAsync(WC.AdminRole))//if roles not exist, create admin and customer role
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {  //admin is loggedin, and can reg new cust
